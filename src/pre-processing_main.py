...
def get_qnames_and_alleles(variant_name):
	...
	try:
		snp_json_path = os.path.join(args.tmp_dir, 'jsons', chrom + '_snps', str(pos) + '.json')
...
def generate_length_distributions_plot(shared_frags_length_list, fetal_frags_length_list, dir):
	...
	plt.savefig(dir, 'plots', 'length_distributions.png')
...
def create_fetal_and_shared_fragment_pools():
